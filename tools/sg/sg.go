...
func init() {
	...
	cmdBNF.Flags().StringVar(&addr, "addr", "./github.com/pingcap/parser/parser.y", "Location of parser.y file. Can also specify an http address.")
	...
	cmdSVG.Flags().BoolVar(&svgSnippet, "snippet", false, "generate html code snippet that can be embedded to another page.(default: false)")
